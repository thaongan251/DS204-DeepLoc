...
# 	l_indrop = DropoutSeqPosLayer(l_in, p=drop_per)
	...
	l_conv_final = lasagne.layers.Conv1DLayer(l_conc, num_filters=n_filt*2, pad='same', stride=1, filter_size=f_size_b, nonlinearity=lasagne.nonlinearities.rectify)
